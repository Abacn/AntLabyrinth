...
// Constructor
//==============================================================
EventHeap::EventHeap(int maxsize_i):
  maxsize(maxsize_i)
{
  a = new int[maxsize];
...
// Constructor
//==============================================================
EventHeap::EventHeap(const EventHeap &h)
{
  maxsize = h.maxsize;
  a = h.a;
  index = h.index;
